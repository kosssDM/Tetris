	...
	case I:
		...
		case 2:
			if ((in_sDetal[0].y + 3 <= FH))
				...
				{
					in_sDetal[1] = { in_sDetal[0].x, in_sDetal[0].y + 1 };
					in_sDetal[2] = { in_sDetal[0].x, in_sDetal[0].y + 2 };
					in_sDetal[3] = { in_sDetal[0].x, in_sDetal[0].y + 3 };
				}
			break;
		case 1:
		case 3:
			if ((in_sDetal[0].x - 1 > 0) && (in_sDetal[0].x + 2 <= CW))
				...
				{
					in_sDetal[1] = { in_sDetal[0].x - 1, in_sDetal[0].y };
					in_sDetal[2] = { in_sDetal[0].x + 1, in_sDetal[0].y };
					in_sDetal[3] = { in_sDetal[0].x + 2, in_sDetal[0].y };
				}
			break;
		}
		break;
		...
		case 0:
			if ((in_sDetal[0].y + 1 <= FH) && (in_sDetal[0].x - 1 > 0) && (in_sDetal[0].x + 1 <= CW))
				if (!in_sField[in_sDetal[0].x][in_sDetal[0].y + 1].dot && !in_sField[in_sDetal[0].x - 1][in_sDetal[0].y].dot && !in_sField[in_sDetal[0].x + 1][in_sDetal[0].y].dot)
				{
					in_sDetal[1] = { in_sDetal[0].x, in_sDetal[0].y + 1 };
					in_sDetal[2] = { in_sDetal[0].x - 1, in_sDetal[0].y };
					in_sDetal[3] = { in_sDetal[0].x + 1, in_sDetal[0].y };
				}
			break;
		case 1:
			if ((in_sDetal[0].y + 2 <= FH) && (in_sDetal[0].x + 1 <= CW))
				...
				{
					in_sDetal[1] = { in_sDetal[0].x, in_sDetal[0].y + 2 };
					in_sDetal[2] = { in_sDetal[0].x, in_sDetal[0].y + 1 };
					in_sDetal[3] = { in_sDetal[0].x + 1, in_sDetal[0].y + 1 };
				}
			break;
		case 2:
			if ((in_sDetal[0].y + 1 <= FH) && (in_sDetal[0].x - 1 > 0) && (in_sDetal[0].x + 1 <= CW))
				...
				{
					in_sDetal[1] = { in_sDetal[0].x, in_sDetal[0].y + 1 };
					in_sDetal[2] = { in_sDetal[0].x - 1, in_sDetal[0].y + 1 };
					in_sDetal[3] = { in_sDetal[0].x + 1, in_sDetal[0].y + 1 };
				}
			break;
		case 3:
		...
		case 1:
			if ((in_sDetal[0].x + 2 <= CW) && (in_sDetal[0].y + 1 <= FH))
				if (!in_sField[in_sDetal[0].x][in_sDetal[0].y + 1].dot && !in_sField[in_sDetal[0].x + 1][in_sDetal[0].y + 1].dot && !in_sField[in_sDetal[0].x + 2][in_sDetal[0].y + 1].dot)
				{
					in_sDetal[1] = { in_sDetal[0].x, in_sDetal[0].y + 1 };
					in_sDetal[2] = { in_sDetal[0].x + 1, in_sDetal[0].y + 1 };
					in_sDetal[3] = { in_sDetal[0].x + 2, in_sDetal[0].y + 1 };
				}
			break;
		case 2:
			if ((in_sDetal[0].x - 1 > 0) && (in_sDetal[0].y + 2 <= FH))
				...
				{
					in_sDetal[1] = { in_sDetal[0].x - 1, in_sDetal[0].y + 2 };
					in_sDetal[2] = { in_sDetal[0].x, in_sDetal[0].y + 2 };
					in_sDetal[3] = { in_sDetal[0].x, in_sDetal[0].y + 1 };
				}
			break;
		case 3:
	...
	case J:
		...
		case 2:
			if ((in_sDetal[0].y + 2 <= FH) && (in_sDetal[0].x + 1 <= CW))
				...
				{
					in_sDetal[1] = { in_sDetal[0].x, in_sDetal[0].y + 2 };
					in_sDetal[2] = { in_sDetal[0].x + 1, in_sDetal[0].y + 2 };
					in_sDetal[3] = { in_sDetal[0].x, in_sDetal[0].y + 1 };
				}
			break;
		case 3:
			if ((in_sDetal[0].x - 2 > 0) && (in_sDetal[0].y + 1 <= FH))
				...
				{
					in_sDetal[1] = { in_sDetal[0].x - 2, in_sDetal[0].y + 1 };
					in_sDetal[2] = { in_sDetal[0].x - 1, in_sDetal[0].y + 1 };
					in_sDetal[3] = { in_sDetal[0].x, in_sDetal[0].y + 1 };
				}
			break;
		...
		case 2:
			if ((in_sDetal[0].y + 2 <= FH) && (in_sDetal[0].x + 1 <= CW))
				if (!in_sField[in_sDetal[0].x][in_sDetal[0].y + 1].dot && !in_sField[in_sDetal[0].x + 1][in_sDetal[0].y + 1].dot && !in_sField[in_sDetal[0].x + 1][in_sDetal[0].y + 2].dot)
				{
					in_sDetal[1] = { in_sDetal[0].x, in_sDetal[0].y + 1 };
					in_sDetal[2] = { in_sDetal[0].x + 1, in_sDetal[0].y + 1 };
					in_sDetal[3] = { in_sDetal[0].x + 1, in_sDetal[0].y + 2 };
				}
			break;
		case 1:
		case 3:
			if ((in_sDetal[0].x + 1 <= CW) && (in_sDetal[0].y + 1 <= FH) && (in_sDetal[0].x - 1 > 0))
				...
				{
					in_sDetal[1] = { in_sDetal[0].x - 1, in_sDetal[0].y + 1 };
					in_sDetal[2] = { in_sDetal[0].x, in_sDetal[0].y + 1 };
					in_sDetal[3] = { in_sDetal[0].x + 1, in_sDetal[0].y };;
				}
			break;
